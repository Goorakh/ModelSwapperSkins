...
namespace ModelSwapperSkins.BoneMapping
{
    public static class BoneInitializer
    {
        ...
        static void Init()
        {
            ...
            AddCustomBoneInitializerRules(BoneInitializerRules_Drifter.Instance);
            AddCustomBoneInitializerRules(BoneInitializerRules_DroneTech.Instance);
            AddCustomBoneInitializerRules(BoneInitializerRules_Engi.Instance);
            AddCustomBoneInitializerRules(BoneInitializerRules_FalseSon.Instance);
            ...
            AddCustomBoneInitializerRules(BoneInitializerRules_Loader.Instance);
            ...
            AddCustomBoneInitializerRules(BoneInitializerRules_RoboBallBoss.Instance);
            ...
            foreach (CharacterBody body in BodyCatalog.allBodyPrefabBodyBodyComponents)
            {
                ...
                string boneSourceBodyName = bodyName;

                if (Chainloader.PluginInfos.ContainsKey("com.CherryDye.MonsterMash"))
                {
                    if (boneSourceBodyName.StartsWith("PC"))
                    {
                        string baseBodyName = boneSourceBodyName.Substring(2);
                        ...
                        if (baseBodyIndex != BodyIndex.None)
                        {
                            ...
                            boneSourceBodyName = BodyCatalog.GetBodyName(boneSourceBody.bodyIndex);
                        }
                    }
                }
                ...
                if (initializerRules == DefaultBoneRules)
                {
                    ...
                    if (boneSourceBodyName.EndsWith("_opt"))
                    {
                        if (BodyCatalog.FindBodyIndex(boneSourceBodyName.Remove(boneSourceBodyName.Length - 4)) != BodyIndex.None)
                        {
                            continue;
                        }
                    }
