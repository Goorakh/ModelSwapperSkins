...
{
    public class BoneInitializerRules_Scav : BoneInitializerRules_AutoName
    {
        public static new readonly BoneInitializerRules_Scav Instance = new BoneInitializerRules_Scav();

        protected BoneInitializerRules_Scav() : base()
        {
        }
