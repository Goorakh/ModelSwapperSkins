    ...
    public class BoneInitializerRules_AutoName : BoneInitializerRules
    {
        ...
        protected override BoneInfo getBoneInfo(Transform modelTransform, Transform potentialBoneTransform)
        {
            switch (potentialBoneTransform.name.ToLower())
            {
                ...
                case "l_index_3_jnt":
                case "finger1_3_l":
                case "finger_pointer_l_02":
                    return new BoneInfo(BoneType.IndexFinger3L);
                case "finger2.1.l":
                case "finger2.l":
                case "middle1.l":
                case "middlefinger1_l":
                case "l_middle_01":
                case "l_middle_1_jnt":
                case "finger2_1_l":
                case "finger_middle_l":
                    return new BoneInfo(BoneType.MiddleFinger1L);
                case "finger2.2.l":
                case "finger2.l.001":
                case "middle2.l":
                case "middlefinger2_l":
                case "l_middle_02":
                case "l_middle_2_jnt":
                case "finger2_2_l":
                case "finger_middle_l_01":
                    return new BoneInfo(BoneType.MiddleFinger2L);
                case "finger2.3.l":
                case "finger2.l.002":
                case "middle3.l":
                case "middlefinger3_l":
                case "l_middle_03":
                case "l_middle_3_jnt":
                case "finger2_3_l":
                case "finger_middle_l_02":
                ...
                case "pinky2.r":
                case "r_pinky_02":
                case "finger_pinky_r_01":
                    return new BoneInfo(BoneType.PinkyFinger2R);
                case "finger4.3.r":
                case "pinky3.r":
                case "r_pinky_03":
                case "finger_pinky_r_02":
