...
{
    public class BoneInitializerRules_Parent : BoneInitializerRules
    {
        public static readonly BoneInitializerRules_Parent Instance = new BoneInitializerRules_Parent();

        protected BoneInitializerRules_Parent() : base()
        {
        }
