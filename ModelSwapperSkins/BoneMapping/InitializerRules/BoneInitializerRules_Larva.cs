...
{
    public class BoneInitializerRules_Larva : BoneInitializerRules
    {
        public static readonly BoneInitializerRules_Larva Instance = new BoneInitializerRules_Larva();

        protected BoneInitializerRules_Larva()
        {
        }
